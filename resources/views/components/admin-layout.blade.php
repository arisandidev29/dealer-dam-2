    ...
    <div class="my-[68px]">
        <div class="drawer lg:drawer-open">
            ...
            <div class="drawer-content p-6">
                ...
                <ul class="md:hidden menu bg-base-200 lg:menu-horizontal rounded-box">
                  ...
                  <li class="{{ Route::is('dashboard.product') || Route::is("dasboard.product.create") || Route::is("dashboard.product.edit") ? 'active_sidebar' : "" }}">
                  ...
                  <li class="{{ Route::is("dashboard.customers") || Route::is("dashboard.customers.create") || Route::is("dashboard.customers.edit") ? "active_sidebar" : "" }}">
